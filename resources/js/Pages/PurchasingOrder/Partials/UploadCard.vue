...
<template>
    <article class="rounded-[1.5rem] border border-white/10 bg-white/90 p-5 shadow-[0_10px_28px_rgba(15,23,42,0.08)]">
        <div class="flex flex-wrap items-start justify-between gap-4">
            ...
            <div class="rounded-full bg-gradient-to-r from-blue-700 via-indigo-600 to-red-600 px-3 py-1 text-xs font-semibold text-white shadow-lg shadow-blue-700/20">
        ...
        <div class="mt-4">
            ...
            <input
                ...
                class="mt-2 block w-full rounded-xl border border-slate-300 bg-white px-3 py-2 shadow-sm focus:border-blue-400 focus:ring-blue-400"
