        ...
        <div class="relative min-h-screen overflow-hidden bg-[#08111f] text-slate-100">
            ...
            <div class="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                <div class="mb-6">
                    ...
                    <h1 class="mt-2 text-3xl font-bold text-white">Tambah Document Template</h1>
                    <p class="mt-2 text-sm text-slate-300">Simpan path view atau file template yang akan dipakai oleh resolver.</p>
                </div>
