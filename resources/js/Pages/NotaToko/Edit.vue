...
import NotaTokoForm from './Partials/Form.vue';
...
<template>
    <Head :title="`Edit Nota Toko - ${notaToko.nomor}`" />
    ...
    <AuthenticatedLayout theme="login">
        <div class="relative min-h-screen overflow-hidden bg-[#08111f] text-slate-100">
            ...
            <div class="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                <div class="mb-6">
                    <p class="text-xs uppercase tracking-[0.3em] text-sky-300">Retail</p>
                    <h1 class="mt-2 text-3xl font-bold text-white">Edit Nota Toko</h1>
                    <p class="mt-2 text-sm text-slate-300">Perbarui data nota, item, dan status pembayaran.</p>
                </div>

                <NotaTokoForm
                    :action="route('nota-toko.update', notaToko.id)"
                    method="put"
                    :notaToko="notaToko"
                    :meta="meta"
                />
